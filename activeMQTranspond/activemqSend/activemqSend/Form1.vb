...
Public Class Form1
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        TextBox4.Text = sysinfo.sendTopicTitle
        TextBox5.Text = sysinfo.recTopicTitle
    End Sub
        ...
        If sysinfo.LinkFlage = False Then
            ...
            Try
                ...
                If sysinfo.MQServerUrl.IndexOf("activemq:") = -1 Then
                    ...
                    TextBox3.Text = sysinfo.MQServerUrl
                End If
                sysinfo.sendTopicTitle = TextBox4.Text
                sysinfo.recTopicTitle = TextBox5.Text
            ...
            'factory.BrokerUri = New Uri(sysinfo.MQServerUrl)
            ...
            consumer = session.CreateConsumer(destRec) 'New Apache.NMS.ActiveMQ.Commands.ActiveMQTopic(sysinfo.topicTitle), connection.ClientId, vbNull, False)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        producer.Send(session.CreateTextMessage(TextBox7.Text))

        TextBox6.AppendText($"{Format(Now(), "[yyyy-MM-dd HH:mm:ss]")} Send: *{TextBox7.Text}*{vbCrLf}")
    End Sub
End Class
